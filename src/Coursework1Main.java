...
public class Coursework1Main {
    ...
    public static void main(String[] args) {
        ...
        testObjectEqual("greatestItem", null, cargo.greatestItem());
        cargo = makeEmptyCargoBox();
        testObjectEqual("CargoBox with ITEM1 added", "[" + ITEM1 + "]", cargo.toString());
        cargo = makeEmptyCargoBox();
        cargo = makeAddTwoItemSameAndNullCargoBox();
        testObjectEqual("CargoBox with ITEM8, null, ITEM8",
                "[expected output]", cargo.toString());
        cargo = makeEmptyCargoBox();
        cargo = makeAddTwoItemAndNullCargoBox();
        testObjectEqual("CargoBox with ITEM1, null, ITEM2",
                "[expected output]", cargo.toString());
